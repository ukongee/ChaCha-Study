    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-sm text-[#8B96B0]">1~{Math.min(10, total)}페이지 요약 생성 중</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-5 pb-6">
          ...
          {generating && (
            <div className="flex items-center gap-3 py-2">
              <img src="/chacha.webp" alt="차차" className="w-8 h-8 object-contain animate-pulse" />
              <p className="text-sm text-[#5B6887]">{nextStart}~{nextEnd}페이지 생성 중...</p>
            </div>
          )}
